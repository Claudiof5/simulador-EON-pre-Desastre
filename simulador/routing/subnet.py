...
class FirstFitSubnet(RoutingBase):
    ...
    def __retorna_informacoes_datapaths(
        ...
        caminhos_isp = FirstFitSubnet._get_caminhos_from_isp(
        ...
        return FirstFitSubnet._get_caminhos_from_topology_filtered(
            requisicao, topology, isp_requisicao
        )
    ...
    def _get_caminhos_from_topology_filtered(
        ...
        for informacoes_caminho in caminhos:
            ...
            if not FirstFitSubnet._caminho_pertence_a_isp(caminho, topology, isp_id):
                continue
