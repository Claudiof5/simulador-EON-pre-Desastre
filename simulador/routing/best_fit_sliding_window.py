...
class FirstFitBestFitDisasterAwareWithArtificialBlock(RoutingBase):
    @staticmethod
    def __str__() -> str:
    ...
    def rotear_requisicao(
        ...
        bloqueio_artificial = (
            FirstFitBestFitDisasterAwareWithArtificialBlock.__bloqueio_artificial(
                requisicao, env
            )
        )
        ...
        requisicao_roteada_com_sucesso = (
            FirstFitBestFitDisasterAwareWithArtificialBlock.__rotear_requisicao(
    ...
    def __rotear_requisicao(
        ...
        ) = FirstFitBestFitDisasterAwareWithArtificialBlock.__retorna_informacoes_datapaths(
            requisicao, topology
        )
        if pelo_menos_uma_janela_habil and indice_melhor_caminho is not None:
            FirstFitBestFitDisasterAwareWithArtificialBlock.__aloca_requisicao(
                requisicao,
                topology,
                informacoes_dos_datapaths,
                env,
    ...
    def __aloca_requisicao(
        ...
        FirstFitBestFitDisasterAwareWithArtificialBlock.__aloca_datapath(
    ...
    def __retorna_informacoes_datapaths(
        ...
        for i, informacoes_caminho in enumerate(caminhos):
            ...
            numero_slots_necessarios = (
                FirstFitBestFitDisasterAwareWithArtificialBlock.__slots_nescessarios(
            ...
            ) = FirstFitBestFitDisasterAwareWithArtificialBlock.informacoes_sobre_slots(
                caminho, topology, numero_slots_necessarios
            )
            ###slots_livres, slots_livres_agrupados, lista_de_inicios_e_fins = FirstFitBestFitDisasterAwareWithArtificialBlock.__informacoes_sobre_slots(caminho, topology)
            dados_do_caminho = {
                "caminho": caminho,
                "distancia": distancia,
    ...
    def informacoes_sobre_slots(
        ...
        for i in range(topology.numero_de_slots):
            if FirstFitBestFitDisasterAwareWithArtificialBlock.__checa_concurrency_slot(
                caminho, topology, i
            ):
