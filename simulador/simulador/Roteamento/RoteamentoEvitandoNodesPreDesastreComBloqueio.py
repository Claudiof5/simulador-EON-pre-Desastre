...
class RoteamentoEvitandoNodesPreDesastreComBloqueio(IRoteamento):
    @classmethod
    def __str__(cls) -> str:
        """Get the string representation of the RoteamentoEvitandoNodesPreDesastreComBloqueio class.

        Returns:
            str: The string representation of the RoteamentoEvitandoNodesPreDesastreComBloqueio class.
        """
    ...
    def rotear_requisicao(
        ...
        bloqueio_artificial = (
            RoteamentoEvitandoNodesPreDesastreComBloqueio.__bloqueio_artificial(
                requisicao, env
            )
        )
        ...
        requisicao_roteada_com_sucesso = (
            RoteamentoEvitandoNodesPreDesastreComBloqueio.__rotear_requisicao(
    ...
    def __rotear_requisicao(
        ...
        informacoes_dos_datapaths, pelo_menos_uma_janela_habil = (
            RoteamentoEvitandoNodesPreDesastreComBloqueio.__retorna_informacoes_datapaths(
                requisicao, topology
            )
        )
        if pelo_menos_uma_janela_habil:
            RoteamentoEvitandoNodesPreDesastreComBloqueio.__aloca_requisicao(
    ...
    def __aloca_requisicao(
        ...
        for informacoes_datapath in informacoes_datapaths:
            if (
                ...
                RoteamentoEvitandoNodesPreDesastreComBloqueio.__aloca_datapath(
    ...
    def __retorna_informacoes_datapaths(
        ...
        for informacoes_caminho in caminhos:
            ...
            numero_slots_necessarios = (
                RoteamentoEvitandoNodesPreDesastreComBloqueio.__slots_nescessarios(
                    requisicao.bandwidth, fator_de_modulacao
                )
            )

            lista_de_inicios_e_fins, maior_janela_caminho = (
                RoteamentoEvitandoNodesPreDesastreComBloqueio.informacoes_sobre_slots(
                    caminho, topology
                )
            )
    ...
    def informacoes_sobre_slots(
        ...
        for i in range(topology.numero_de_slots):
            if RoteamentoEvitandoNodesPreDesastreComBloqueio.__checa_concurrency_slot(
                caminho, topology, i
            ):
