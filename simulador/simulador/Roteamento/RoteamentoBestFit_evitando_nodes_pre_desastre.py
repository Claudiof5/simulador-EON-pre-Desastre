...
class RoteamentoBestFit_evitando_nodes_pre_desastre(IRoteamento):
    ...
    def rotear_requisicao(
        ...
        requisicao_roteada_com_sucesso = (
            RoteamentoBestFit_evitando_nodes_pre_desastre.__rotear_requisicao(
    ...
    def __rotear_requisicao(
        ...
        ) = RoteamentoBestFit_evitando_nodes_pre_desastre.__retorna_informacoes_datapaths(
            requisicao, topology
        )
        if pelo_menos_uma_janela_habil:
            RoteamentoBestFit_evitando_nodes_pre_desastre.__aloca_requisicao(
                requisicao,
                topology,
                informacoes_dos_datapaths,
                env,
    ...
    def __aloca_requisicao(
        ...
        RoteamentoBestFit_evitando_nodes_pre_desastre.__aloca_datapath(
    ...
    def __retorna_informacoes_datapaths(
        ...
        for i, informacoes_caminho in enumerate(caminhos):
            ...
            numero_slots_necessarios = (
                RoteamentoBestFit_evitando_nodes_pre_desastre.__slots_nescessarios(
            ...
            ) = RoteamentoBestFit_evitando_nodes_pre_desastre.informacoes_sobre_slots(
    ...
    def informacoes_sobre_slots(
        ...
        for i in range(topology.numero_de_slots):
            if RoteamentoBestFit_evitando_nodes_pre_desastre.__checa_concurrency_slot(
                caminho, topology, i
            ):
