...
TEMPO_DE_REACAO              :float = 45
VARIANCIA_TEMPO_DE_REACAO    :float = TEMPO_DE_REACAO * 0.1
TAMANHO_DATACENTER           :float = THROUGHPUT * 125
VARIANCIA_TAMANHO_DATACENTER :float = TAMANHO_DATACENTER * 0.1


INICIO_DESASTRE = 225
VARIANCIA_INICIO_DESASTRE = 225 * 0.1
DURACAO_DESASTRE = 180
